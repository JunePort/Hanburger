...
public class ShaderCode : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m = new Material(image.material);// ����Image��ԭʼ���ʣ�����ʵ�����������޸Ĺ�������Ӱ��������Ƭ
        image.material = m;

        visual = GetComponentInParent<CardVisual>();

        string[] editions = new string[4];
        editions[0] = "REGULAR";       // ��ͨ��
        editions[1] = "POLYCHROME";    // ��ɫ�棨�Ʋ⣩
        editions[2] = "REGULAR";       // ��ͨ�棨�ظ����Ӹ��ʣ�
        editions[3] = "NEGATIVE";      // ��Ƭ�棨�Ʋ⣩
