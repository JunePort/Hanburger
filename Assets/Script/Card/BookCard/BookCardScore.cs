...
public class BookCardScore : MonoBehaviour
{
    ...
    {
        BookCardScore instance = Instance; // ��ȡΨһʵ��
    ...
    {
        Boss_Goal_Text.text = "Ŀ��" + (socre_percent == 1 ? " " : (socre_percent == 0.9f ? "(90%)" : "(80%)")) + ":" + ((int)(CardList.Instance.cardBoss.GetScoreGoal() * socre_percent)).ToString();
    }
